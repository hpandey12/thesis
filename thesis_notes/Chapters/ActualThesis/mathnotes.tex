...
\subsubsection{Interfacial Jump Conditions}
...
The mass flow across the interface is satisfied using the Rankine-Hugoniot condition. 



The formulation of the interfacial energy jump condition is complicated
and will be avoided here for brevity. This is generally replaced by 
the conditions of phase change at the interface.
...
\end{equation}
The term $\rho_{i} \vect{n}_{i} \cdot (\vect{v}_{i} - \vetor{v}_{\X(t)})$ consists of the local instantaneous 
...
\begin{equation}
\vect{\Gamma} = (m_{vl}\vetor{v}_{l} - m_{lv}\vetor{v}_{v}) a_{lv}\,.
\end{equation}

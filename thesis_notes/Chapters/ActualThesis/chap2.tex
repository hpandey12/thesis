...
Based on the volume fraction of the phase $i$, $\alpha_{i} = V_{i}/V$, where in each cell $\sum_{i} \alpha_{i} = 1$.
...
\begin{align}
\text{density, } \rho &= \sum_{i} \alpha_{i} \rho_{i},\\
\text{viscosity, }\mu &= \sum_{i} \alpha_{i} \mu_{i},\\
\text{velocity, }\vetor{v} &= \frac{1}{\sum_{i} \alpha_{i} \rho_{i}} \sum_{i} \alpha_{i} \vetor{v}_{i} \rho_{i},\\
\text{specific heat, }C_{p} &= \sum_{i} \alpha_{i} \frac{C_{p,i}\rho_{i}}{\sum_{i} \alpha_{i} \rho_{i}},\\
\text{thermal conductivity, }k &= \sum_{i} \alpha_{i} k_{i},\\
\text{enthalpy, }\mathrm{H} &= \frac{1}{\sum_{i} \alpha_{i} \rho_{i}} \sum_{i} \alpha_{i} \rho_{i} \mathrm{H}_{i} + \frac{|\vetor{v}|^{2}}{2},\\
\end{align}
\end{subequations}
...
\begin{description}[labelindent=20pt,labelsep=10pt]
\item[$\vetor{a}$] is the surface area vector,
\item[$\alpha_{i}$] is the volume fraction that fulfills the requirement $\sum_{i}^{n} \alpha_{i} = 1$,
...
\item[$\vetor{M}_{i}$] is the interphase momentum transfer term per unit volume that satisfies $\sum_{i = 1}^{n}\vetor{M}_{i} = 0$,

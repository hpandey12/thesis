...
The model utilises the reynolds averaging of the already averaged form of the conservation 
 ...
 ensemble averaging for repeatable transient situations. ~\cite{hirschNumericalComputationInternal2007}
The effects of turbulence through this averaging procedure introduces additional
 ...
 production, dissipation, and transport. The k-w models solves two additional transport 
 equations for the turbulent kinetic energy and specific dissipation rate - defined as the dissipation rate 
 per unit turbulent kinetic energy. ~\cite{hirschNumericalComputationInternal2007, dartevelleComprehensiveApproachesMultiphase2005, wilcoxTurbulenceModelingCFD2006}
...
\subsection{Evaporation and Flash Evaporation}
...
\subsubsection{Flash evaporation}

\begin{itemize}
    \item Vapour generation rate
\end{itemize}
\subsection{Interface Capturing and Multiple Flow Regimes}
vof - hric --face density reconstruction order, enable gradient smoothing?
\subsection{Multiphase Interactions}
Multiphase Interations - surface tension, vof-vof phase interaction

// Simcenter STAR-CCM+ macro: star2.java
...
public class star2 extends StarMacro {
  ...
  private void execute0() {
    ...
    simulation_0.get(GlobalParameterManager.class).createGlobalParameter(ScalarGlobalParameter.class, "T_bulk");

    ScalarGlobalParameter scalarGlobalParameter_17 = 
      ((ScalarGlobalParameter) simulation_0.get(GlobalParameterManager.class).getObject("T_bulk"));

    scalarGlobalParameter_17.setDimensions(Dimensions.Builder().temperature(1).build());

    simulation_0.get(GlobalParameterManager.class).createGlobalParameter(ScalarGlobalParameter.class, "T_wall");

    ScalarGlobalParameter scalarGlobalParameter_18 = 
      ((ScalarGlobalParameter) simulation_0.get(GlobalParameterManager.class).getObject("T_wall"));
  ...
  private void execute1() {
    ...
    scalarGlobalParameter_17.getQuantity().setValue(0.0);

    scalarGlobalParameter_17.getQuantity().setUnits(units_4);

    ScalarGlobalParameter scalarGlobalParameter_18 = 
      ((ScalarGlobalParameter) simulation_0.get(GlobalParameterManager.class).getObject("T_wall"));

    scalarGlobalParameter_18.getQuantity().setValue(0.0);

    scalarGlobalParameter_18.getQuantity().setUnits(units_1);
  }
  ...
  private void execute11() {
    ...
    nameAttributeFeature_0.renameTopology2(face_6, "max_z", 135, 206, 250, 255, true, 1.0, false);

    Face face_7 = 
      ((Face) extrusionMerge_0.getStartCapFace(lineSketchPrimitive_0));

    nameAttributeFeature_0.renameTopology2(face_7, "min_z", 135, 206, 250, 255, true, 1.0, false);
    ...
    nameAttributeFeature_0.renameTopology2(face_8, "walls", 135, 206, 250, 255, true, 1.0, false);
    ...
    nameAttributeFeature_0.renameTopology2(face_9, "walls", 135, 206, 250, 255, true, 1.0, false);
    ...
    nameAttributeFeature_0.renameTopology2(face_10, "walls", 135, 206, 250, 255, true, 1.0, false);

    Face face_11 = 
      ((Face) extrusionMerge_0.getSideFace(lineSketchPrimitive_0,"True"));

    nameAttributeFeature_0.renameTopology2(face_11, "bottom", 135, 206, 250, 255, true, 1.0, false);
  ...
  private void execute12() {
    ...
    //Journaling deletion of Face name Tags

    //Journaling deletion of Edge name Tags

    //Journaling deletion of Body Tags

    //Journaling deletion of BodyGroup Tags

    //Journaling deletion of face name attributes
    ...
    NamedFaces namedFaces_1 = 
      ((NamedFaces) cadmodelerBody_2.getNamedFacesManager().getObject("walls"));

    cadmodelerBody_2.getNamedFacesManager().delete(new NeoObjectVector(new Object[] {namedFaces_1}));

    //Journaling deletion of edge name attributes

    //Journaling deletion of edge name attributes

    DeleteAttributeFeature deleteAttributeFeature_0 = 
      (DeleteAttributeFeature) cadModel_0.getFeatureManager().getFeature(9);

    deleteAttributeFeature_0.setPresentationName("Remove Name 1");

    deleteAttributeFeature_0.setFeatureBaseCreationVersion(19);
  }
  ...
  private void execute13() {
    ...
    nameAttributeFeature_1.renameTopology2(face_10, "min_x", 135, 206, 250, 255, true, 1.0, false);
    ...
    nameAttributeFeature_1.renameTopology2(face_9, "max_y", 135, 206, 250, 255, true, 1.0, false);
    ...
    nameAttributeFeature_1.renameTopology2(face_8, "max_x", 135, 206, 250, 255, true, 1.0, false);

    nameAttributeFeature_1.setPresentationName("Rename 2");

    nameAttributeFeature_1.setFeatureBaseCreationVersion(19);
